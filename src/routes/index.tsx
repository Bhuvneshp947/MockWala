        ...
        <div className="mx-auto max-w-6xl px-4 py-16 text-sm text-muted-foreground">
          <div className="grid gap-12 md:grid-cols-3">
            <div className="flex flex-col gap-1">
              ...
              <span className="mt-2 text-lg font-bold text-foreground/90">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#exams" className="hover:text-primary transition-colors">Browse Exams</a></li>
                <li><a href="/auth" className="hover:text-primary transition-colors">Sign Up</a></li>
                <li><a href="/" className="hover:text-primary transition-colors">Dashboard</a></li>
              </ul>
            </div>
            <div className="space-y-3">
              <h4 className="font-semibold text-foreground">Exams</h4>
              <ul className="space-y-2 text-sm">
                <li><span className="hover:text-primary transition-colors cursor-pointer">UPSC CSE</span></li>
                <li><span className="hover:text-primary transition-colors cursor-pointer">Banking Exams</span></li>
                <li><span className="hover:text-primary transition-colors cursor-pointer">SSC Exams</span></li>
              </ul>
            </div>
          </div>
          <div className="mt-10 border-t border-border pt-6">
            <p className="text-xs leading-relaxed text-muted-foreground">
              Mock tests for Indian competitive exams. Always verify official dates on the conducting
              body&apos;s website. © 2026 MockWala. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
