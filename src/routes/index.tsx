...
export const Route = createFileRoute("/")({
  loader: ({ context }) =>
    context.queryClient.ensureQueryData(examsQuery),
  ...
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "MockWala — Mock Tests for Competitive Exams",
      },
      {
...
function Home() {
  ...
  const subjectsFor = (exam: ExamRow) =>
    data.subjects.filter(
      (subject: SubjectRow) => subject.exam_id === exam.id
    );
      ...
      <div className="flex-1">
          ...
          <div className="relative mx-auto max-w-6xl px-4 py-20 sm:py-28">
            <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_420px]">
              ...
              <div>
                ...
                >
                  Choose UPSC, IBPS, SSC, RRB or school entrance exam
                  categories. Select a subject, solve a timed mock test drawn
                  from that exam&apos;s question pool, and review a full report.
                </p>
              ...
              <aside className="hidden lg:flex lg:justify-end">
                <div className="hero-image-wrap">
                  ...
                  <img
                    src="/image.png"
                    alt="MockWala learner community"
        ...
        >
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-muted-foreground">
                Dates below are the currently announced or expected schedules.
                Select an exam to see its subjects and start a mock test.
              </p>
            </div>
          ...
          <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {data.exams.map((exam: ExamRow, index: number) => (
              <Link
                key={exam.id}
                to="/exam/$slug"
        ...
        <section className="mx-auto max-w-6xl px-4 py-16 sm:py-20">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-muted-foreground">
              Experience the most comprehensive and interactive mock test
              platform designed specifically for Indian competitive exams.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={feature.title}
                  className="animate-slide-in-up group rounded-2xl border border-border bg-card p-6 shadow-card transition-all duration-300 hover:shadow-lift"
                  style={{
                    animationDelay: `${index * 50}ms`,
                  }}
                >
                  <div className="mb-5 flex size-12 items-center justify-center rounded-xl bg-primary-soft text-primary transition-transform duration-300 group-hover:scale-110">
